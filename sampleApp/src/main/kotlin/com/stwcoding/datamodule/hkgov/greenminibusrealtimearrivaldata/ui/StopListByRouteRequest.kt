    ...
    Column {
        ...
        Button(
            ...
            onClick = {
                scope.launch {
                    onResponseReceived(
                        client.getStopListByRouteAPI(routeId, routeSequence).fetch().getOrNull()
                    )
                }
            }
        ) {
        ...
        Button(
            ...
            onClick = {
                scope.launch {
                    onResponseReceived(
                        client.getStopListByRouteAPI(routeId, routeSequence).fetchLastUpdate().getOrNull()
                    )
                }
            }
        ) {
            Text(text = "Stop Route List last update")
        }
    }
}